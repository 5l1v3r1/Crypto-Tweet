...
def BTC():
    ...
    with open('ticker.json') as json_data:
        ...
        if change[0:1] == '-':
            api.update_status(status="#BTC: "+current+"TL"+up+"(-"+change_a+")\n"+time)
        elif change == '0':
            api.update_status(status="#BTC: "+current+"TL"+"("+change_a+")\n"+time)
        else:
            api.update_status(status="#BTC: "+current+"TL"+down+"(+"+change_a+")\n"+time)
...
def ETH():
    ...
    with open('ticker.json') as json_data:
        ...
        if change[0:1] == '-':
            api.update_status(status="#ETH: "+current+"TL"+up+"(-"+change_a+")\n"+time)
        elif change == '0':
            api.update_status(status="#ETH: "+current+"TL"+"("+change_a+")\n"+time)
        else:
            api.update_status(status="#ETH: "+current+"TL"+down+"(+"+change_a+")\n"+time)
...
def LTC():
    ...
    with open('ticker.json') as json_data:
        ...
        if change[0:1] == '-':
            api.update_status(status="#LTC: "+current+"TL"+up+"(-"+change_a+")\n"+time)
        elif change == '0':
            api.update_status(status="#LTC: "+current+"TL"+"("+change_a+")\n"+time)
        else:
            api.update_status(status="#LTC: "+current+"TL"+down+"(+"+change_a+")\n"+time)
